...
//--Para llamar a todos los Registros de Zapatillas--//
const todos = (req, res) => {
    connection.query("SELECT * FROM Producto WHERE id_categoria = 1", (error, results) => {
            if (error) throw error;
            res.json(results);
...
module.exports={crear,todos,editar,eliminar,unoSolo}